...
<br>Note: The following classes are added to the body.
<br>am-embedactivity - The class is added to the body when the modal is displayed.
<br>am-hidetitle - The class is added to the body when the title is hidden.
<br>am-hideactivityheader - The class is added to the body when the activity header is hidden.
<br>am-hidesecondarynav - The class is added to the body when the secondary navigation is hidden.
<br>am-hideblock - The class is added to the body when the block is hidden.
<br>am-hidepageheader - The class is added to the body when the page header is hidden.
<br>am-hidetitle - The class is added to the body when the title is hidden.';
...
$string['showsecondarynav'] = 'Show secondary navigation';
